<?php 
    ...
    $verified_accounts = $connection->query("SELECT * FROM `accounts` WHERE `verification_status` = 'verified' AND `user_type` = '3' ORDER BY `date_registered` DESC")->fetchAll(PDO::FETCH_ASSOC);
...
<p class="mb-4">
    Below is a list of all verified resident accounts registered in the system. Use the table to review account details, including registration date and verification status.
</p>
