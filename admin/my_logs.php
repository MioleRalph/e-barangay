...
<p class="mb-4">
    Below is a detailed record of all your recent activities. You can filter, search, and download your logs for reference or auditing purposes.
</p>
                ...
                <tbody>
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars(decryptData($logs['name'])); ?></td>
