<?php
    ...
    function sendEmail_verification($firstName, $email, $verification_token){
        ...
        try {
            ...
            //Recipients
            $mail->setFrom('maujo_malitbog@e-barangay.online', $firstName);
...
<div class="container mt-5" style="max-width: 600px;">
    <div class="card shadow-lg border-0 rounded-lg">
        <div class="card-header bg-primary text-white text-center">
            <h4 class="mb-0">Register New Official Account</h4>
        </div>
        <div class="card-body p-4">
            <form action="" method="POST" enctype="multipart/form-data" autocomplete="off">
                <input type="hidden" id="account_type" name="account_type" value="3" />
