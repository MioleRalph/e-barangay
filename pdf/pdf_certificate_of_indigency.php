...
$stmt = $connection->query("SELECT * FROM file_request WHERE transaction_type = 'Certificate of Indigency' ORDER BY date_submitted DESC");
$events = $stmt->fetchAll(PDO::FETCH_ASSOC);

$pdf = new MYPDF();
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('e-Barangay System');
$pdf->SetTitle('Certificate of Indigency Report');
...
$pdf->Cell(0, 12, 'Certificate of Indigency Report', 0, 1, 'C');
...
$pdf->Ln(6);
$pdf->SetFont('dejavusans', 'B', 10);
$pdf->Cell(0, 8, "Total Certificate of Indigency Requests: " . count($events), 0, 1, 'L');
$pdf->Cell(0, 8, "Total Amount Collected for Certificate of Indigency Requests: ₱" . number_format($total, 2), 0, 1, 'L');
...
// Output the PDF
$pdf->Output('certificate_of_indigency.pdf', 'I');
?>
