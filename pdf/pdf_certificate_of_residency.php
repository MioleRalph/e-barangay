...
$stmt = $connection->query("SELECT * FROM file_request WHERE transaction_type = 'Certificate of Residency' ORDER BY date_submitted DESC");
$events = $stmt->fetchAll(PDO::FETCH_ASSOC);

$pdf = new MYPDF();
$pdf->SetCreator(PDF_CREATOR);
$pdf->SetAuthor('e-Barangay System');
$pdf->SetTitle('Certificate of Residency Report');
...
$pdf->Cell(0, 12, 'Certificate of Residency Report', 0, 1, 'C');
...
$pdf->Ln(6);
$pdf->SetFont('dejavusans', 'B', 10);
$pdf->Cell(0, 8, "Total Certificate of Residency Requests: " . count($events), 0, 1, 'L');
$pdf->Cell(0, 8, "Total Amount Collected for Certificate of Residency Requests: ₱" . number_format($total, 2), 0, 1, 'L');
