                ...
                <ul class="timeline">
                    <li>
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-white">Established to serve and support the community.</p></div>
                        </div>
                    </li>
                    <li class="timeline-inverted">
                        ...
                        <div class="timeline-panel">
                            ...
                            <div class="timeline-body"><p class="text-white">Expanded services to meet the growing needs of residents.</p></div>
                        </div>
                    </li>
                </ul>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="components/img/team/1.jpg" alt="..." />
                            <h4 class="text-white">Juan Dela Cruz</h4>
                            <p class="text-white">Barangay Captain</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="components/img/team/2.jpg" alt="..." />
                            <h4 class="text-white">Maria Santos</h4>
                            <p class="text-white">Secretary</p>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="team-member">
                            <img class="mx-auto rounded-circle" src="components/img/team/3.jpg" alt="..." />
                            <h4 class="text-white">Pedro Reyes</h4>
                            <p class="text-white">Treasurer</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer class="footer py-4">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-4 text-lg-start text-white">Copyright &copy; Barangay Assistance 2023</div>
                </div>
            </div>
        </footer>
        <!-- Bootstrap core JS-->
