<?php
    ...
    $announcements_list = $connection->query("SELECT * FROM `announcements` WHERE `category` = 'Events' AND `status` = 'Active' ORDER BY `created_at` DESC")->fetchAll(PDO::FETCH_ASSOC);
