<?php
    ...
    $announcements_list = $connection->query("SELECT * FROM `announcements` WHERE `category` = 'Public Notice' AND `status` = 'Active' ORDER BY `created_at` DESC")->fetchAll(PDO::FETCH_ASSOC);
