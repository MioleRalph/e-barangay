<?php
    ...
    $announcements_list = $connection->query("SELECT * FROM `announcements` WHERE `category` = 'Job Postings' AND `status` = 'Active' ORDER BY `created_at` DESC")->fetchAll(PDO::FETCH_ASSOC);
                ...
                <div class="col mb-4">
                    <div class="card h-100 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><strong>Category:</strong> <?php echo (decryptData($announcement['category'])); ?></p>
                        </div>
