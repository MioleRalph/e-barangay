<?php 
    ...
    $account = $select_account->fetch(PDO::FETCH_ASSOC);
        ...
        $notification_message = "New Barangay Clearance request submitted by " . strtoupper($full_name) . " Email: " . strtoupper($email) . ". Please review and process the request.";
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="ref_number" name="ref_number" aria-describedby="refHelp" required>
